 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Help our children to get their daily needs here.</h1>
            <p class="lead fw-normal text-white-50 mb-0">Start here!</p>
        </div>
    </div>
</header>
<!-- Section-->
...
<section class="py-5">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="./uploads/step.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
