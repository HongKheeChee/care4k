        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="book-tab" data-toggle="tab" href="#book" role="tab" aria-controls="book" aria-selected="true" colour="white">Items</a>
                </li>
                <?php if(isset($_GET['c'])): ?>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content pt-2 bg-white">
