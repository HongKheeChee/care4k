                    ...
                    <div class="content-wrapper">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Inkind donation list
                                            <a href="http://localhost/charity/donation/?p=my_account" class="btn btn-primary float-end">Donation</a>
                                        </h4>
                                    </div>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $qry = $con->query("SELECT o.*,concat(c.firstname,' ',c.lastname) as client from `orders` o inner join clients c on c.id = o.client_id 
