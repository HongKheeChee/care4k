...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
                                ...
                                <a href="/charity/admin/index.php" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Admin Menu</a>
				...
				<a href="index.php?page=site_settings" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-cogs"></i></span> Settings</a>
                                <a href="/charity/employ/index.php" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-laptop"></i></span> Webpage preview</a>
