              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-1">
                   ...
                   <li class="nav-item dropdown">
                      <a href="/charity/admin/index.php" class="nav-link nav-hom">
                   ...
                   <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="./?page=reminders/manage_reminder" class="nav-link tree-item nav-reminders_manage_reminder">
                            <i class="fa fa-plus nav-icon"></i>
                            <p>Add New</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="./?page=reminders" class="nav-link tree-item nav-reminders">
                    ...
                    <li class="nav-item dropdown">
                      <a href="/charity/donation/admin/index.php" class="nav-link" target="_blank">
                        <i class="nav-icon fas fa-laptop"></i>
                        <p>
                          donate
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="/charity/employ/admin/index.php" class="nav-link" target="_blank">
                        <i class="nav-icon fas fa-laptop"></i>
                        <p>
                          Calender
                        </p>
