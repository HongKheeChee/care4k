                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        ...
                                        <p>empower to make impact to the orphaned children</p>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        ...
                                        <p>connecting individuals and organizations with orphanages</p>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-flex flex-column justify-content-end">
                                        ...
                                        <p>create a brighter future for these children by </p>
                                            <p>providing them with care, resources, and opportunities</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="/charity/employ/index.php" class="d-block">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="http://localhost/charity/?p=articles&t=e4da3b7fbbce2345d7772b0674a318d5" class="d-block">
                                <img src="images/icons/home.png" class="featured-block-image img-fluid" alt="">

                                <p class="featured-block-text"><strong>Info </strong>of Shelter</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="custom-text-box">
                            ...
                            <h5 class="mb-3">Care4kids, Non-Profit Organization</h5>

                            <p class="mb-0">A group of passionate individuals came together with a common dream: 
                                to make a difference in the lives of orphaned children and to create a brighter future for them. 
                                This is the story of how our project, "Care4kids," was born.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="custom-text-box mb-lg-0">
                                    ...
                                    <p>At Care4kids, our mission is to create a positive and lasting impact on the lives of orphaned children and the dedicated homes that provide them with care and support. 
                                        </p>

                                    <ul class="custom-list mt-2">
                                        <li class="custom-list-item d-flex">
                                            <i class="bi-check custom-text-box-icon me-2"></i>
                                            Provide an overview of daily needs of orphange home for user to donate daily item.
                                        </li>

                                        <li class="custom-list-item d-flex">
                                            <i class="bi-check custom-text-box-icon me-2"></i>
                                            We are dedicated to being a bridge of hope, connecting compassionate individuals and organizations with orphanages in the Penang area.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="custom-text-box d-flex flex-wrap d-lg-block mb-lg-0">
                                    <div class="counter-thumb">
                                        <div class="d-flex">
                                            <span class="counter-number" data-from="10" data-to="2023"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-7 col-12">
                        <div class="custom-text-block">
                            <h2 class="mb-0">Our Office</h2>

                            <p class="text-muted mb-lg-4 mb-md-4">Bayan Lepas</p>

                            <p>The collected donation goods will be stored here , and ready to deliver to respective homes</p>

                            <p>You are welcome to visit our office here </p>
                            ...
                            <a href="https://www.google.com/maps/dir//Bayan+Lepas,+Penang/@5.2945481,100.2181273,13z
                                /data=!4m9!4m8!1m0!1m5!1m1!1s0x304abfdc16a86cd3:0x62916eeda71a89b0!2m2!1d100.2593272!2d5.
                                294464!3e0?entry=ttu" class="custom-btn btn mt-3">Get Direction</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <a href="/charity/donation/index.php" class="me-4">Make a donation</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block-wrap">
                            ...
                            <div class="custom-block">
                                ...
                                <a href="/charity/donation/index.php" class="custom-btn btn">Donate now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <p class="text-white">Volunteering can provide a healthy boost to your self-confidence, self-esteem, and life satisfaction.
                                 You are doing good for others and the community, which provides a natural sense of accomplishment.</p>

                        <form class="custom-form volunteer-form mb-5 mb-lg-0" action="/charity/employ/index.php" method="post" role="form">
        ...
        <section class="news-section section-padding" id="section_5">
            ...
            ?>
                        ...
                        <div class="news-block">
                            <div class="news-block-top">
                                <a href="news-detail.html">
                                    <img src=<?php echo validate_image($row['img_path']) ?>
                            ...
                            <div class="news-block-info">
                                ...
                                <div class="news-block-title mb-2">
                                    <h4><a href="http://localhost/charity/?p=events" class="news-block-title-link">We <?php echo $row['title'] ?></a></h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-12 mx-auto">
                        <form class="custom-form search-form" action="http://localhost/charity/?p=search&search=shan" method="post" role="form">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h2 class="mb-lg-3">Our Volunteer and Donators</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 mb-4">
                    <img src="images/c4k Logo.jpg" class="logo img-fluid" alt="">
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li class="footer-menu-item"><a href="#section_4" class="footer-menu-link">Newsroom</a></li>

                        <li class="footer-menu-item"><a href="#section_3" class="footer-menu-link">Causes</a></li>

                        <li class="footer-menu-item"><a href="/charity/employ/index.php" class="footer-menu-link">Become a volunteer</a></li>

                        <li class="footer-menu-item"><a href="/charity/employ/index.php" class="footer-menu-link">Partner with us</a></li>
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <p class="copyright-text mb-0">Copyright © 2023 <a href="#">Care4kids</a> 
                            <a href="https://templatemo.com" target="_blank"></a><br>
